...
export default function Hero() {
  ...
  return (
    <section className="h-[60vh] relative flex flex-col items-center justify-center gap-4 my-40">
      <h1 className="uppercase font-light font-anybody text-3xl text-green">
        {" "}
        {t.rich("title", {
      ...
      <h2 className="uppercase font-bold font-anybody-condensed text-6xl pixel-text">
        {t("subtitle")}
      </h2>
      ...
      <div className="flex flex-col items-center border-[1px] border-green border-dash-wide">
        <section className="w-full text-center bg-gradient-to-b from-black to-green-800 py-4 font-anybody font-bold">
          <p className="relative z-10 text-2xl sm:text-3xl uppercase">
        ...
        <p
          className="
      mt-3 max-w-2xl px-8 py-6 text-center font-roboto-mono text-base sm:text-xl
      text-white/90 uppercase tracking-[.18em]
    ...
    "
      ...
      <div className="space-y-4 relative p-2 bg-black -top-8 flex flex-col border-[1px] border-green rounded-md w-full max-w-lg">
