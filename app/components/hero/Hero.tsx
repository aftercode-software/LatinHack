  ...
  return (
    <section className="relative flex flex-col items-center justify-center gap-4 pt-20">
      <header className="flex flex-col items-center relative hero-header">
        <h1 className="uppercase font-light font-anybody text-xl md:text-3xl text-green text-center hero-title invisible">
          {t.rich("title", {
        ...
        <div className="">
          <img
            src="/logo.png"
            alt="logo"
            className="h-32 md:h-48 w-full hero-logo md:-mt-4 invisible"
          />
        </div>
      ...
      <section className="relative isolate py-6 md:py-0">
        ...
        <div className="relative z-10 flex flex-col items-center animate-[slideDown_1s_ease-out]">
          <h2 className="main-title uppercase font-bold font-upheaval text-5xl md:text-8xl text-center pixel-text text-white drop-shadow-[0_0_20px_rgba(0,255,255,0.8)] invisible">
            {t("subtitle")}
          </h2>
          <Prizes />
          <img
            src="/flechon.png"
            alt=""
            className="w-30 object-contain animate-bounce arrow invisible"
          />
          <CountDown />
        </div>
      </section>
